  ...
  import com.myapp.domainobject.CarDO; import com.myapp.domainvalue.EngineType;
  import com.myapp.service.car.CarService; import org.junit.Test; import
  ...
  org.springframework.boot.test.context.SpringBootTest; import static
  org.junit.Assert.assertEquals;
  
  @RunWith(SpringJUnit4ClassRunner.class)
  
  @WebMvcTest(value = CarController.class, secure = false) public class
  CarControllerTest {
  ...
  private CarDO carDOResult = new CarDO(LICENSE_PLATE, 4, false, 10,
  EngineType.GAS, "MERCEDES");
  
  @Test public void createCar() throws Exception {
  
  Mockito.when(carService.create(Mockito.any(CarDO.class))).thenReturn(
  carDOResult);
  
  String exampleCar =
  "{\"licensePlate\":\"546PW\",\"seatCount\":\"4\",\"convertible\":\"false\",\"rating\":\"10\",\"engineType\":\"GAS\",\"manufacturer\":\"MERCEDES\"}";
